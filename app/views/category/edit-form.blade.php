...
<body>
    ...
    <div class="container">
        ...
        <form action="./save-update-cate?id={{$model->id}}" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="show_menu" class="form-control" value="{{$model->show_menu}}">
                    </div>
                    <div class="form-group">
